 ...
 * option if there are more than element that match [selectorDrag]. One more option
 * is [makeDraggable] if you want to make [selectorDrag] element draggable.
 * You have to set [dropLocation] option to specify point where elment will be dropped.
 */
